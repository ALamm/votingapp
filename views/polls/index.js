...
exports.init = function(req, res){
    ...
    collection.find({},{ _id: 0, question:1, url:1}).toArray(function (err,docs) {
        ...
        // console.log('Summary Polls page:', polls);        
        res.render('polls/index', {polls:polls, noPolls:noPolls});  // send the object with key = 'polls' to the jade page
    });
};
